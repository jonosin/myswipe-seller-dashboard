    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={async () => {
            ...
            if (res.status === "pending") { toast.error("Your seller account is pending. Complete verification before adding products."); return; }
      ...
      {loading ? (
        ...
        <DataTable
          ...
          onRowClick={async (p) => {
            const res = await getSellerStatus();
            if (res.status === "pending") { toast.error("Account pending. You cannot edit products yet."); return; }
