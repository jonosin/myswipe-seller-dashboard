...
const dict: Record<Lang, Dict> = {
  en: {
    ...
    products: {
      ...
      rejectedTitle: "Rejected listings",
      rejectedDesc: "These listings were rejected by admin. Please review the reason and update your listing before resubmitting.",
  ...
  th: {
    ...
    products: {
      ...
      rejectedTitle: "รายการที่ถูกปฏิเสธ",
      rejectedDesc: "รายการเหล่านี้ถูกผู้ดูแลปฏิเสธ โปรดตรวจสอบเหตุผลและแก้ไขข้อมูลก่อนส่งใหม่",
